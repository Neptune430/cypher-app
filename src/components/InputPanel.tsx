...
export default function InputPanel({ inputs, setInputs, onGenerate, loading, error, loadingMessage }: Props) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Error */}
      {error && (
        <div className="relative overflow-hidden rounded-2xl border border-red-200 bg-gradient-to-br from-red-50 via-white to-white shadow-sm p-4 flex items-start gap-3 fade-up">
          <div className="w-8 h-8 rounded-full bg-red-100 flex items-center justify-center flex-shrink-0">
            <AlertTriangle size={15} className="text-red-500" />
          </div>
          <div>
            <p
              className="text-[10px] font-bold text-red-500 uppercase tracking-widest mb-1"
              style={{ fontFamily: "var(--font-mono)" }}
            >
              Heads up
            </p>
