  ...
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="July 30, 2026">
      ...
      <p>
        ...
        content. Anthropic&apos;s own privacy practices govern how they handle that request, you can read
        their policy directly at{" "}
        <a href="https://www.anthropic.com/legal/privacy" target="_blank" rel="noopener noreferrer">
          anthropic.com/legal/privacy
        </a>. The site itself is hosted on Vercel, which provides the underlying infrastructure.
      </p>
